...
class CVEditor:
    ...
    def create_experience_objects(request,cv, edit):
        ...
        for company, position, work_start, work_end in zip_longest(company,position,
                                                                    work_start,work_end):
            experience_entry= Experience(cv=cv, occupation=position, company=company,
                                            start_work=work_start,end_work=work_end)
    ...
    def create_education_objects(request,cv,edit):
        ...
        for institution, start, end in zip_longest(institution, study_start, study_end):
            education_entry = Education(cv=cv,institution=institution,
                                        study_start=start,study_end=end)
